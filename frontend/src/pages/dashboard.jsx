...
function StageIndicator({ label, active, done }) {
  return (
    <div
...
function Dashboard() {
  ...
  const isDone1 =
    isRequiresPayment || isWaitingWallet || isVerifying || isSuccess;
              ...
              {earningsLoading && !earnings ? (
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    {earnings && Object.keys(earnings.byAsset).length > 0 ? (
                  ...
                  {earnings && earnings.recentPayments.length > 0 && (
                    <div>
                      ...
                      <div className="space-y-2">
                        {earnings.recentPayments.slice(0, 3).map((p) => (
                          <div
                            key={p.txid}
            ...
            <div className="glass-panel p-6 sm:p-8 rounded-3xl min-h-full flex flex-col">
              ...
              <div className="flex-1 flex flex-col min-h-[320px]">
                <AnimatePresence mode="wait">
                  ...
                  {isRequiresPayment && stage.type === "requires_payment" && (
                    <motion.div
                      key="402"
                  ...
                  {isVerifying && stage.type === "verifying" && (
                    <motion.div
                      key="verifying"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
